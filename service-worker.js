parcelRequire=function(e,r,t,n){var i,o="function"==typeof parcelRequire&&parcelRequire,u="function"==typeof require&&require;function f(t,n){if(!r[t]){if(!e[t]){var i="function"==typeof parcelRequire&&parcelRequire;if(!n&&i)return i(t,!0);if(o)return o(t,!0);if(u&&"string"==typeof t)return u(t);var c=new Error("Cannot find module '"+t+"'");throw c.code="MODULE_NOT_FOUND",c}p.resolve=function(r){return e[t][1][r]||r},p.cache={};var l=r[t]=new f.Module(t);e[t][0].call(l.exports,p,l,l.exports,this)}return r[t].exports;function p(e){return f(p.resolve(e))}}f.isParcelRequire=!0,f.Module=function(e){this.id=e,this.bundle=f,this.exports={}},f.modules=e,f.cache=r,f.parent=o,f.register=function(r,t){e[r]=[function(e,r){r.exports=t},{}]};for(var c=0;c<t.length;c++)try{f(t[c])}catch(e){i||(i=e)}if(t.length){var l=f(t[t.length-1]);"object"==typeof exports&&"undefined"!=typeof module?module.exports=l:"function"==typeof define&&define.amd?define(function(){return l}):n&&(this[n]=l)}if(parcelRequire=f,i)throw i;return f}({"H8CW":[function(require,module,exports) {
...
},{"../modules/es6.object.to-string":"H8CW","../modules/es6.string.iterator":"TImV","../modules/web.dom.iterable":"TFcQ","../modules/es6.promise":"GHd0","../modules/es7.promise.finally":"oZrx","../modules/es7.promise.try":"lcFA","../modules/_core":"dqAF"}],"mOg0":[function(require,module,exports) {
module.exports={default:require("core-js/library/fn/promise"),__esModule:!0};
},{"core-js/library/fn/promise":"CWjI"}],"AaGI":[function(require,module,exports) {
"use strict";var e=t(require("babel-runtime/core-js/promise"));function t(e){return e&&e.__esModule?e:{default:e}}var n="photobooth-vs25",r=["/index.html"];self.addEventListener("install",function(e){console.log("[SW] Install"),self.skipWaiting(),e.waitUntil(caches.open(n).then(function(e){return e.addAll(r).then(function(){console.log("Worker Install Complete")})}))}),self.addEventListener("activate",function(t){console.log("[SW]","Activate!"),t.waitUntil(caches.keys().then(function(t){return e.default.all(t.filter(function(e){return e!==n}).map(function(e){return caches.delete(e)}))}))}),self.addEventListener("fetch",function(e){e.respondWith(caches.match(e.request).then(function(t){if(t)return console.info("Serving ".concat(e.request.url," from SW Cache")),t;var r=e.request.clone();return fetch(r).then(function(t){if(!t||200!==t.status||"basic"!==t.type)return t;var r=t.clone();return e.waitUntil(caches.open(n).then(function(t){t.put(e.request,r)})),t})}))});
},{"babel-runtime/core-js/promise":"mOg0"}]},{},["AaGI"], null)
